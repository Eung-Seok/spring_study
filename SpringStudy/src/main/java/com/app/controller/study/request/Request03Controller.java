...
//		System.out.println(request.getParameter("p3")); //단일 파라미터 값
	...
	public String param4(@RequestParam String p1, String p2) {
	...
	public String param7(@RequestParam Map<String, String> paramMap) {
							//요청에 담겨온 파라미터 값을이 key:value 형태로 저장되어 전달됨
	...
	public String param8( ) {
		...
		System.out.println("/request03/param8 [GET요청]");
		return "/req/param/param8";
	}
	
	@PostMapping("/param8")  //POST 쓰기/저장 데이터 전달 -> 실제 데이터 받고 로직 철
