...
public class Rest03Controller {
	...
	public ApiResponseHeader response2() {
		...
		apiResponseHeader.setResultMsg(ApiCommonCode.API_RESULT_SUCCESS_MSG);
	...
	public ApiResponse<User> response5(){
		...
		apiResponseHeader.setResultMsg(ApiCommonCode.API_RESULT_EMPTY_DATA_MSG);
